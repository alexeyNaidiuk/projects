...
def post(proxy, target, text):
    ...
    request = {'url': 'https://www.boddingtonparish.co.uk/index.php/contact-form', 'headers': dict(
        [('content-length', '1925'), ('cache-control', 'max-age=0'),
         ...
         ('origin', 'https://www.boddingtonparish.co.uk'),
         ('content-type', 'multipart/form-data; boundary=----WebKitFormBoundary0IKCxg647jyLZcqu'), ('user-agent',
                                                                                                    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36'),
         ('accept',
          'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9'),
         ('sec-fetch-site', 'same-origin'), ('sec-fetch-mode', 'navigate'), ('sec-fetch-user', '?1'),
         ('sec-fetch-dest', 'document'), ('referer', 'https://www.boddingtonparish.co.uk/index.php/contact-form'),
         ('accept-encoding', 'gzip, deflate, br'), ('accept-language', 'ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7'), (
         'cookie',
         'b2ee7abd406e6be1b88a66b52be512d6=afc890cff58b4c9a709636eed644dea0; _ga=GA1.3.906801494.1663855399; _gid=GA1.3.1926554695.1663855399; _gat_gtag_UA_30244976_1=1')]),
               'data': data}
    resp = requests.post(**request, proxies={'http': proxy, 'https': proxy})
    return resp
...
def spam(target='softumwork@gmail.com'):
    ...
    print('successfully' in content, target)
